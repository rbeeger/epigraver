...
class HorizontalSlideAnimator: Animator {
    ...
    func setup(boxes: [NSBox], on view: NSView) {
        ...
        animationConstraints.append(boxes[0].centerXAnchor.constraint(equalTo: view.centerXAnchor))
        ...
        animationConstraints.append(boxes[1].centerXAnchor.constraint(equalTo: view.centerXAnchor,
